...
var errorOnRewrite = flag.Bool("error", false,
	"return an error if any rewrites succeed (to check for cleanliness)")
...
func usage() {
	fmt.Fprintf(os.Stderr, "usage: algofix [-diff] [-r fixname,...] [-force fixname,...] [-x] [path ...]\n")
	flag.PrintDefaults()
